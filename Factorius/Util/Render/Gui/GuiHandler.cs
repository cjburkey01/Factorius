	...
	class GuiHandler {
		...
		public static void GenerateBackground(List<Vector3> verts, List<Vector2> uvs, List<int> tris, Vector2 s, string state) {
			...
			tris.AddRange(new int[] {
				i + 2, i + 0, i + 1,		i + 3, i + 2, i + 0,
				i + 6, i + 4, i + 5,		i + 7, i + 6, i + 4,
				i + 10, i + 8, i + 9,		i + 11, i + 10, i + 8,
				i + 14, i + 12, i + 13,		i + 15, i + 14, i + 12,
				i + 18, i + 16, i + 17,		i + 19, i + 18, i + 16,
				i + 22, i + 20, i + 21,		i + 23, i + 22, i + 20,
				i + 26, i + 24, i + 25,		i + 27, i + 26, i + 24,
				i + 30, i + 28, i + 29,		i + 31, i + 30, i + 28,
				i + 34, i + 32, i + 33,		i + 35, i + 34, i + 32,
			});
		}
